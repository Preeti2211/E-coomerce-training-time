...
<nav class="navbar navbar-expand-md  navbar-light">
    ...
    <div class="collapse navbar-collapse " id="myNavbar">
        <div class="container-fluid">
            <div class="row" style="min-height: 2500px">
                <!-- sidebar navbar -->
                <div class="col-lg-3 sidebar fixed-top" style="min-height: 2500px">
                    <a href="/" class="navbar-brand text-white d-block mx-auto text-center mb-4 bottom-border pb-2 text-uppercase font-weight-bold">
                        Admin
                    </a>

                    <img src="images/bag12.webp" width="50"height="50" alt="nice" class="rounded-circle mr-3">
                    <a href="/" class="text-white font-weight-bold" style="font-family: 'Monotype Corsiva';font-size: 25px;">Loveshree </a>
                    <div class="border-bottom pb-3"></div>
                    <ul class="navbar-nav flex-column mt-4" style="min-height:700px;background:blue">
                        <li class="nav-item">
                ...
                <!--  top nav-->
                <div class="col-lg-9  ml-auto bg-dark fixed-top py-2 top-navbar" style="min-height: 2500px">
